<section class="content">
    <div class="card">
                    ...
                    <tr>
                        ...
                        <td class="custom_actions">
                            <div class="btn-group">
                                ...
                                <a href="{!! route('sbu.edit', $row->id) !!}" class="btn btn-flat btn-outline-info btn-sm" data-toggle="tooltip" title="Edit">
                                    <i class="far fa-edit"></i>
                                </a>
                                <form method="post" class="list_delete_form" action="{!! route('sbu.destroy', $row->id) !!}" accept-charset="UTF-8" >
                                    {!! csrf_field() !!}
        ...
        <div class="card-footer">
            {{ $sbus->withQueryString()->links('pagination::bootstrap-5') }}
        </div>
    </div>
